...
public class FunctionExam01 {
	...
	public static void main(String[] args) {
		...
		int result1= evenSum(number); //2550
		int result2= oddSum(number); //2500
		
		System.out.println("짝수합: " + result1);
		System.out.println("홀수합: " + result2);
	}
	...
	public static int oddSum(int number) { //홀수합
		int sum = 0;
		for(int i=0; i<=number; i++) {
			if(i%2 == 1) // if(!(i%2 == 0) 내가 ㅇㅈㄹ하다가 막혓다니...
			sum += i;
		}
		return sum;
	}	
